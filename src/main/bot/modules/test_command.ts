...
import { _, AppCommand, field, MessageView, StateContext } from '../../../discord-framework'
...
const test_command_definition = new AppCommand({
...
export const test_module = [new CustomView(testCommand), new CustomView(helperView)]
