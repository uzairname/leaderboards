...
import { Colors, dateTimestamp, escapeMd, messageLink } from '../../../messages/message_pieces'
        ...
        components: [
          {
            ...
            custom_id: create_ranking_view_definition
              .newState({ callback: createRankingModal })
              .cId(),
            label: 'Ranking',
            emoji: {
              name: '➕',
