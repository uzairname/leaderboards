...
import { matchesCommand, matchesCommandSignatureInGuild } from './matches_command'
...
export const matches_module = [
  new CustomView(matchesView),
  new CustomView(matchView),
  new CustomView(matchesCommand, matchesCommandSignatureInGuild),
]
