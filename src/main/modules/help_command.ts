...
import { InteractionContext, AppCommandDefinition, _, field, StateContext } from '../../discord-framework'
...
export const help_cmd = new AppCommandDefinition({
...
export const help = [globalView(helpCmd)]
